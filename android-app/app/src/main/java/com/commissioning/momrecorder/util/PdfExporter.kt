...
object PdfExporter {
    ...
    private class PageWriter(
        ...
        fun drawMom(r: MomReport) {
            ...
            canvas.drawText("MOM Recorder • AI-Powered", MARGIN, 58f, Paint().apply {
            ...
            y += 10f
            canvas.drawText(
                "Generated by MOM Recorder • ${java.text.SimpleDateFormat("MMM dd, yyyy HH:mm", java.util.Locale.getDefault()).format(java.util.Date())}",
